...
**{ms学习}官：** 我看你简历上写你做了个秒杀系统？我们就从这个项目开始吧，先介绍下你的项目。
...
**{ms学习}官：** 你简历上写的这个 J.U.C 包是什么啊？（他居然不知道 JUC）
...
**总结：** 一面可能是简历面吧，问的比较简单，我在讲项目中说出了我做项目时的学习历程和思考，赢得了{ms学习}官的好感，感觉他应该给我的评价很好。
...
**{ms学习}官:** HR 好像不太满意我的答案，继续问我还有缺点吗？
