...
有胆就来，我出几道 Mybatis {ms学习}题，看你能回答上来几道（都是我出的，可不是网上找的）。

#### 1、#{}和\${}的区别是什么？

注：这道题是{ms学习}官{ms学习}我同事的。
...
{ms学习}题看似都很简单，但是想要能正确回答上来，必定是研究过源码且深入的人，而不是仅会使用的人或者用的很熟的人，以上所有{ms学习}题及其答案所涉及的内容，在我的 Mybatis 系列博客中都有详细讲解和原理分析。