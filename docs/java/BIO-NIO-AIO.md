熟练掌握 BIO,NIO,AIO 的基本概念以及一些常见问题是你准备{ms学习}的过程中不可或缺的一部分，另外这些知识点也是你学习 Netty 的基础。
...
如果是在{ms学习}中回答这个问题，我觉得首先肯定要从 NIO 流是非阻塞 IO 而 IO 流是阻塞 IO 说起。然后，可以从 NIO 的3个核心组件/特性为 NIO 带来的一些改进来分析。如果，你把这些都回答上了我觉得你对于 NIO 就有了更为深入一点的认识，{ms学习}官问到你这个问题，你也能很轻松的回答上来了。
